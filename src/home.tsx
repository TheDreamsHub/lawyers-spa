  ...
  var teamMember = [{img:"حوكمة الشركات",name:"عمر الغامدي",title:"محامي"},{img:"حوكمة الشركات",name:"عمر الغامدي",title:"محامي"},{img:"حوكمة الشركات",name:"عمر الغامدي",title:"محامي"},{img:"حوكمة الشركات",name:"عمر الغامدي",title:"محامي"}];
    ...
    <div>
     ...
     <div >
      ...
      {/*  hero */}
      <div className='bg-hero w-full bg-cover bg-no-repeat h-[1100px] relative items-center mb-[90px] pt-6' >
            <div  className='bg-dots  bg-no-repeat absolute top-6 left-6 mx-auto lg:w-[250px] lg:h-[250px]' />
            <div  className='bg-logo  bg-no-repeat mx-auto  w-[240px] md:w-0 h-[240px]' />
            <div data-aos="slide-left" data-aos-duration="800" className='m-auto w-7/12 text-right flex flex-col'>

                <div     className='bg-logo  bg-no-repeat  lg:w-[420px] lg:h-[300px]' />
                <p className=' text-white text-xl'>تتشرف شركتنا بتقديم خدماتها لمجموعة من</p>
                <p className='text-[#D0BF95] text-3xl'>أصحاب السمو الملكي الأمراء، وكبريات الشركات والمؤسسات المحلية والعالمية التي تعمل في مجال المقاولات وتقنية المعلومات والتأمين والتجارة العامة .</p>
                <button className="w-[140px] bg-[#B9A061] rounded-lg text-white p-2 float-left mt-16" onClick={()=>{
                  navigate('/contact-us');
                }}>
                تواصل معنا  
                </button>
      ...
      <div  className='w-10/12 m-auto mb-[90px] '>
          <div className='text-center'>
            ...
            <div data-aos="fade-up" className='flex w-full gap-12 flex-wrap text-right m-auto justify-center '>
              {servicesVersion.map((service) =>{
                ...
                return <div className='shadow-none scale-1 hover:shadow-md p-2 transition-all duration-500 rounded-md lg:hover:scale-110 hover:text-[#773415] text-[#64748B]'>
        ...
        <div className='lg:w-8/12 m-auto mb-[90px]'>
          ...
          <WayOfWork point='الثغرات القانونية' isRight={false} title='ندرس بعمق ونتتبع أطراف الموضوع وامتداداته.'/>
          <WayOfWork point='خطة العمل' isRight={true} title='ندرس بعمق ونتتبع أطراف الموضوع وامتداداته.'/>
          <WayOfWork point='ورش العمل' isRight={false} title='ندرس بعمق ونتتبع أطراف الموضوع وامتداداته.'/>
          <WayOfWork point='العمل إلكترونيا' isRight={true} title='ندرس بعمق ونتتبع أطراف الموضوع وامتداداته.'/>
          <WayOfWork point='الجودة' isRight={false} title='ندرس بعمق ونتتبع أطراف الموضوع وامتداداته.'/>
      ...
      {/* divider */}
        <div className='w-full bg-gradient-to-r from-[#411D0C] to-[#54250F] h-[209px] flex items-center text-right relative mb-[90px]'>
          <div className='bg-vectors w-[200px] h-[200px] absolute left-0'></div>
              <p className='w-7/12 m-auto text-white lg:text-[24px]'>تقوم شركتنا بتمثيلكم في حضور الاجتماعات والمفاوضات , إلى جانب تمثيلكم في جميع الدعاوى سواء مدعياً أو مدعاً عليه , أمام كافة المحاكم و اللجان شبه القضائية والإدارية .</p>
        </div>
