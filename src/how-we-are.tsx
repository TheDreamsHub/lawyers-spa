    ...
    return (
        <div>
            ...
            <div className="max-w-[1200px] mx-auto ">
                ...
                <div className='bg-dots  bg-no-repeat absolute -top-24 left-0 lg:-top-24 lg:-left-24 w-[250px] h-[250px] -z-10' />

                    <p className="text-2xl mb-3">رؤيتنا</p>
                    <p>نسعى إلى أن نكون المكتب المتميز على مستوى المملكة في تقديم الخدمات والاستشارات القانونية</p>
                </div>
                <div className="border rounded mb-4 p-8 bg-white">
                    <p className="text-2xl mb-3">رسالتنا</p>
                ...
                <div className="border rounded mb-4 p-8">
                    <p className="text-2xl mb-3">أهدافنا</p>
                ...
                <div className="border rounded mb-4 p-8">
                    <p className="text-2xl mb-3">مايميزنا :</p>
                    <ul className="list-disc pr-5">
